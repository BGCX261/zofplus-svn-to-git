...
String id101rdp = request.getParameter("101rdpid");


String salida = controladorsve.Visar101RDP(id101rdp);
Long numeroprovisorio;
numeroprovisorio = controladorsve.ObtenerNumeroProvisorio101EXT();
