...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                formu_adoTable =  $('#grillanv').dataTable( {
                    "bJQueryUI": true,
    ...
    <body>        
        ...
        <div id=titulo style="margin:60% 2%;font:80px calibri;color:#e4e4e4;position:absolute;">Nota de Venta</div>
        <div id="contenedor">
            <div id="TabbedPanels1" class="TabbedPanels">
                <ul class="TabbedPanelsTabGroup">
                    <li class="TabbedPanelsTab" tabindex="0">Nota de Venta</li>
                    <li class="TabbedPanelsTab" tabindex="0">Nueva Nota de Venta</li>
                </ul>
                <div class="TabbedPanelsContentGroup">
                    ...
                    <div class="TabbedPanelsContent">
                        ...
                        <br/>
                        <table class="display" id="grillanv" style="width:100%;">
                            <thead>
                                <tr>
                                    <th>ID NV</th>
                                    <th>Fecha de Nota de Venta</th>
                                    <th>Glosa</th>
                                    <th>Codigo Moneda</th>
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                            RN_NotaVenta notaventa = new RN_NotaVenta();
                                            List li = notaventa.ListarNotaVenta();
                                            Iterator itr = li.iterator();
                                            while (itr.hasNext()) {
                                                NotaDeVenta nv = (NotaDeVenta) itr.next();
                                %>
                                <tr>

                                    <td><div align="center"><%=nv.getNvId()%></div></td>
                                    <td><div align="center"><%=nv.getNvFecha()%></div></td>
                                    <td><div align="center"><%=nv.getNvCodigomoneda()%></div></td>
                                    <td><div align="center"><%=nv.getNvPaisdestino()%></div></td>
                                </tr>
                                <%
                                            }
                                %>
                    ...
                    <div class="TabbedPanelsContent">
                        ...
                        <form id="formu_ad" name="formu_ad" method="post" action="item_nota_venta.jsp">
                            <div id="plantilla_ingreso">
                                <fieldset>
                                    <b><legend>Nueva Nota de Venta</legend></b>
                                    <table>
                                        <tr>
                                            <td style="width:210px;font: 13px calibri;background-color:#8387b4;"><b>::Datos Requeridos </b></td><td style="width:25%;font: 13px calibri;background-color:#8387b4"><b>::Ingresar </b></td><td style="width:25%;font: 13px calibri;background-color:#8387b4;"><b>::Datos Requeridos</b></td><td style="width:25%;font: 13px calibri;background-color:#8387b4;"><b>::Datos Requeridos</b></td>

                                        </tr>
                                        <tr>
                                            <td style="width:25%;border:1px solid #eee;"><br/><label>Numero de Nota de Venta</label><br/><br/><label>Cliente</label><br/><br/><label>Glosa</label><br/><br/><br/><br/><br/><br/><br/></td>
                                            <td style="width:140px;border:1px solid #eee;">
                                                <input type="text" name="numero_nv" size="30" readonly="readonly" value="<%=notaventa.ObtieneCorrelativoNotaVenta()%>" /><br/><br/>
                                                <select name="agregar_cli_rut" class="required">
                                                    <option value="">Seleccionar Cliente</option>
                                                    <%

                                                                RN_Persona cliente = new RN_Persona();
                                                                List li1 = cliente.ListarCliente();
                                                                Iterator it1 = li1.iterator();
                                                                while (it1.hasNext()) {
                                                                    Cliente c1 = (Cliente) it1.next();
                                                                    out.println("<option value='" + c1.getPerRut()+ "'>");
                                                                    out.println(c1.getPersona().getPerNombre()+" Usuario ZF:"+c1.getUsuarioZonafr()+"");
                                                                    out.println("</option>");
                                                                }
                                                    %>
                                                ...
                                                <textarea name="glosa_nv" cols="23" rows="3" class="required"></textarea><br/><br/><br/><br/>
                                            </td>
                                            <td style="width:25%;border:1px solid #eee;"><br/><label>Moneda Local</label><br/><br/><label>Origen del Producto</label><br/><br/><label>Forma de Pago</label><br/><br/><br/><br/><br/><br/><br/></td>
                                            <td style="width:140px;border:1px solid #eee;">
                                                <select name="moneda_nv" style="width:210px;font:13px calibri;">
                                                ...
                                                <select name="pais_destino_nv" style="width:210px;font:13px calibri;">
            ...
            <select name="forma_pago" class="required">
                ...
                <option value="CTDO">Contado</option>
                <option value="CRED">Credito</option>
                                ...
                                <input id="btn" type="submit" value="[Generar Nueva Nota de Venta]" style="width:230px;margin-left:550px;font:15px calibri;"/>&nbsp;&nbsp;<input type="reset" value="[ Limpiar ] " style="width:70px" />
                            </div>
                        </form>
                    </div>
