...
//
//   1. incluir en el <HEAD> el c�digo
//
...
//
//
//   3. Para mostrar la ventana de seleccion de fechas desde un input text con id="fecha_ejemplo" poner el c�digo....
//
//   		<input type="text" id="fecha_ejemplo" size="20" onclick="javascript:showVentanaSeleccionFechas('fecha_ejemplo', 'Fecha de ejemplo');">
//
//
//   4. Para mostrar un calendario desde un input text con id="fecha_ejemplo" de un formulario "formEjemplo" poner el c�digo....
//
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function Aceptar(camposeleccion) {
		...
		// si todo ha ido bien...
			...
			// damos formato a la visualizaci�n de la fecha
	...
	///////////////////////////////////////////////////////////////////
	//Ocultamos las ventanas dependiendo de las que est�n abiertas////
	/////////////////////////////////////////////////////////////////
	...
	function Calendario(Fecha)
	{
	  ...
	  PrimerDia.setDate(1);
		 ...
		 // es el dia 1 del mismo mes y a�o (p.e, 1-11-1999) 
	 ...
	 <!-- Escritura en la pantalla de la tabla correspondiente al mes actual -->
	    ...
	    CalendarioTexto = CalendarioTexto + '<table border="0" cellpadding="0" cellspacing="1" width="100%" class="blanco" BORDERCOLOR="red" CELLSPACING="0><tr><td>'
