...
//RESCATAMOS QUE TIPO DE OPERACION SE VA A HACER
            String oca101id = request.getParameter("oca101idrdp");
            if (oca101id == null) {
...
<script type="text/javascript" charset="utf-8">
    ...
    <body>
        ...
        <div id=titulo style="margin:60% 2%;font:80px calibri;color:#e4e4e4;position:absolute;">Nuevo 101 RDP</div>
        <div id="contenedor">
            <div id="TabbedPanels1" class="TabbedPanels">
                ...
                <div class="TabbedPanelsContentGroup">
                    ...
                    <div class="TabbedPanelsContent" style="font:13px calibri;">
                        ...
                        <form id="form_101rdp" name="form_101rdp" method="post" action="paso_101rdp.jsp">




                            <fieldset style="color:#b01414;"><legend><font style="font:17px calibri;background:#b01414;color:#fff;">Cabecera Ingreso 101-Resto del Pais - N°: <%=id_101%> </font></legend>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="region" id="region" class="required">
                                                <option value="">Seleccione Region de Procedencia</option>
                                                <option value="02">02.-REGION DE ANTOFAGASTA</option>
                                                <option value="03">03.-REGION DE ATACAMA</option>
                                                <option value="04">04.-REGION DE COQUIMBO</option>
                                                <option value="05">05.-REGION DE VALPARAISO</option>
                                                <option value="06">06.-REGION DEL GENERAL BERNARDO OHIGGINS</option>
                                                <option value="07">07.-REGION DEL MAULE</option>
                                                <option value="08">08.-REGION DEL BIO-BIO</option>
                                                <option value="09">09.-REGION DE LA ARAUCANIA</option>
                                                <option value="10">10.-REGION DE LOS LAGOS</option>
                                                <option value="11">11.-REGION DE COYHAIQUE</option>
                                                <option value="12">11.-REGION DE MAGALLANES</option>
                                                <option value="13">14.-REGION DE LOS RIOS</option>
                                                <option value="RM">11.-REGION METROPOLITANA</option>
                                            </select>
                                        </td>
                                    </tr>
