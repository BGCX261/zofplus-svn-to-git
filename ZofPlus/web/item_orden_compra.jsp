...
<br/><br/>
    <fieldset style="width:802px;margin-left:20%;background:#fff;border:2px dashed #000;">
         <b><legend>Generando nueva Orden de Compra</legend></b>
    <form action="paso_item_oc.jsp" id="agregarfactura">

    <!-- ID Proveedor oculto -->
    <input name="provRut" id="provRut" type="hidden"  maxlength="10" value="<%=provRut %>"/>


    <div id="page-wrap">
        <textarea id="header" readonly="readonly">Orden de Compra n°<%=ocId%></textarea>
            <div id="identity">
                <textarea id="address">
                    Rut Del Proveedor:<%=provRut%>
                ...
                <div id="logo">
                    ...
                    <div id="customer">
                            <table id="meta">
                                <tr>
                                    <td class="meta-head">Numero OC</td>
                                    <td><input name="num_fac_agr" id="num_fac_agr"  maxlength="10" value="<%=ocId %>" readonly="readonly" autocomplete="off"/></td>
                                </tr>
                                <tr>
                        ...
                        <table id="items">
                                ...
                                <tr id="hiderow">
                                    <td colspan="5"><a id="addrow" style="font:15px calibri;" href="javascript:;" title="Agregar Item">Agregar Item a la Orden de Compra</a></td>
                                </tr>
